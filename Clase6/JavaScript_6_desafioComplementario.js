...
//Pido al vendedor que ingrese cuantas ventas hizo en sus turnos e ingreso el dato en el array usando el metodo push
for (let i = 1; i <= turnosTrabajados; i++) {
    ...
    ventasTotalArray.push(ventasTurno);
}

//Uso el array recorriendolo con un for para obtener la cantidad total de ventas
for (i = 0; i < ventasTotalArray.length; i++){
    ventasTotal += ventasTotalArray[i];
}
